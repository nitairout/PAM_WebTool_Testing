...
/*
 * This test verifies if the data is corrected as expected for a site when there is a Dip (temporary drop in the value)
 * */
public class QIDM_158_DipWithCatchUpSpike extends TestBase {
	LoginTC login = null;
	@Test
	public void dipWithCatchUpSpike() throws Throwable {
		try {
			...
			//Select Electric commodity for a site DipWithCatchUpSpike
			searchSiteInLocationList("DipWithCatchUpSpike");
			getWebElementXpath("DQElectricitySiteAfterFilter").click();
			Reporter.log("Searched for 'DipWithCatchUpSpike' site");
			...
			//Legend verification
			Assert.assertEquals(getWebElementXpath("LineLegendOne").getText(), "QA Site 1 \\...\\ DipWithCatchUpSpike kWh");
			...
			Thread.sleep(1000);
			Assert.assertEquals(getWebElementActionXpath("ChartFlagPopUpHeaderSiteName").getText(), "QA Site 1 \\...\\ DipWithCatchUpSpike");
			...
			Assert.assertEquals(getWebElementXpath_D("//*[@id='tablehead']/tr[1]/th[2]").getText(), "QA Site 1 \\ Z_Data Quality Scenarios \\ DipWithCatchUpSpike");
			...
			//Table Header verification
			Assert.assertEquals(getWebElementActionXpath_D("//*[@id='tablehead']/tr[1]/th[2]").getText(), "QA Site 1 \\ Z_Data Quality Scenarios \\ DipWithCatchUpSpike");
