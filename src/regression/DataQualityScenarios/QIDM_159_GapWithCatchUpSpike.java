...
/*
 * This test verifies if the data is corrected as expected for a site/meter where it has a 'Gap with Catch-up spike' 
 * (a missing interval without time stamp and value, followed by a spike) 
 * */
public class QIDM_159_GapWithCatchUpSpike extends TestBase {
	LoginTC login = null;
	@Test
	public void gapWithCatchUpSpike() throws Throwable {
		try {
			...
			//Select Electric commodity for a site GapWithCatchUpSpike
			searchSiteInLocationList("GapWithCatchUpSpike");
			getWebElementXpath("DQElectricitySiteAfterFilter").click();
			Reporter.log("Searched for 'GapWithCatchUpSpike' site");
			...
			//Legend verification
			Assert.assertEquals(getWebElementXpath("LineLegendOne").getText(), "QA Site 1 \\...\\ GapWithCatchUpSpike kWh");
			...
			Thread.sleep(1000);
			Assert.assertEquals(getWebElementActionXpath("ChartFlagPopUpHeaderSiteName").getText(), "QA Site 1 \\...\\ GapWithCatchUpSpike");
			...
			Assert.assertEquals(getWebElementXpath_D("//*[@id='tablehead']/tr[1]/th[2]").getText(), "QA Site 1 \\ Z_Data Quality Scenarios \\ GapWithCatchUpSpike");
			...
			//Table Header verification
			Assert.assertEquals(getWebElementActionXpath_D("//*[@id='tablehead']/tr[1]/th[2]").getText(), "QA Site 1 \\ Z_Data Quality Scenarios \\ GapWithCatchUpSpike");
