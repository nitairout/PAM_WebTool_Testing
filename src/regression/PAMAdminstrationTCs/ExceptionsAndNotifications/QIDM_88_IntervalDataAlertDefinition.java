...
public class QIDM_88_IntervalDataAlertDefinition extends TestBase {
	LoginTC login = null;
	...
	public void intervalDataAlertDefinition() throws Throwable {
		try {
			...
			Thread.sleep(2000);
			getWebElementXpath_D("/html/body/form/div[5]/div[1]/div/app-root/form-exception/div/div[1]/div[2]/div[2]/kendo-tabstrip/div[2]/div/notification-component/div/div/table/tr[2]/td[2]/input").click();
