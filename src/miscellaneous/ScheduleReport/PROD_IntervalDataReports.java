...
public class PROD_IntervalDataReports extends TestBase{
@Test(retryAnalyzer = NoRetry.class)
	public void prodIntervalDataDailyReports() throws Exception
	{
			try {
						...
						if(emails.contains("Auto_Prod")  ) {
							reportCounter++;
								if(emails.contains(executionTodayDate)) {
									...
									printLog("There is no Prod report generated today.;");
									throw new Exception("Seems like there is no Prod report generated today");
								}
								break;
					}
				}
