...
Public Class TestToolConfig
    ...
    Private Sub FillApplicationNames()
        ...
        Dim path As String = ConfigurationManager.AppSettings("ConfigFilePath") &
        ...
        cmbApp.DataSource = lstApplicationNames
        cmbApp.SelectedItem = 0
    ...
    Private Sub cmbApp_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbApp.SelectedIndexChanged
        ...
        'If cmbApp.SelectedItem.ToString() = "EEM" Then
        '    ' CBMS selected
        '    ' LoadCBMS()
    ...
    Private Sub FillCBMSValuesFromExcel()
        ...
        txtUserName.Text = CType(eCell(2, 3), Excel.Range).Value.ToString()
        txtPassword.Text = CType(eCell(2, 4), Excel.Range).Value.ToString()
    ...
    ' Fill values from Excelsheet
    Private Sub FillGenericValuesFromExcel()
        Try
            ' Read data from Excelsheet => sheet 1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If cmbApp.SelectedItem.ToString() = "CBMS" Then
            ...
            Try
                ...
                CType(Sheet1.Cells(2, 1), Excel.Range).Value = trackInfo.Item(cmbEnv.SelectedItem.ToString())
                CType(Sheet1.Cells(2, 2), Excel.Range).Value = cmbBrowser.SelectedItem.ToString()
                CType(Sheet1.Cells(2, 5), Excel.Range).Value = txtEmail.Text
                CType(Sheet1.Cells(2, 3), Excel.Range).Value = txtUserName.Text
                CType(Sheet1.Cells(2, 4), Excel.Range).Value = txtPassword.Text
        ...
        ElseIf cmbApp.SelectedItem.ToString() <> "CBMS" Then
            ...
            Try
                ...
                'cmbEnv.SelectedItem = trackInfo.Item(DirectCast(inputSheet.Cells(3, 1), Excel.Range).Value).ToString()
                'CType(Sheet1.Cells(3, 1), Excel.Range).Value = cmbEnv.SelectedValue
                'String key = ((KeyValuePair < String, String > )comboBox1.SelectedItem).Key;
                'Dim key As String = trackInfo.Item(DirectCast(cmbEnv.SelectedItem.ToString(), (KeyValuePair(Of String, String))).Item1).ToString()
                '                DictionaryEntry deImgType = (DictionaryEntry)cmbImageType.SelectedItem;
                'MessageBox.Show(deImgType.Key + ": " + deImgType.Value);

                'Dim deInfo As DictionaryEntry = trackInfo.Item(DirectCast(cmbEnv.SelectedItem, DictionaryEntry))

                'CType(Sheet1.Cells(3, 1), Excel.Range).Value = deInfo.Key
